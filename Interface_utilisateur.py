...
Button_calculus=Button(main,text="Lancer les calculs",command=lambda : Princ.test_draw_traited(filename.get(),Methode.get(),int(nombre_generation.get()),int(nombre_indiv.get())),state='disabled' )
